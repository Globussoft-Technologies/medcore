...
export default function DashboardLayout({
  ...
  const NAV_LABEL_TO_KEY: Record<string, string> = {
    ...
    "Platform Billing": "dashboard.nav.platformBilling",
    Observability: "dashboard.nav.observability",
    Requisitions: "dashboard.nav.requisitions",
    Departments: "dashboard.nav.departments",
    Materials: "dashboard.nav.materials",
    Leads: "dashboard.nav.leads",
    "Care Cohorts": "dashboard.nav.careCohorts",
    "AI Booking": "dashboard.nav.aiBooking",
    "AI Scribe": "dashboard.nav.aiScribe",
    Diagnosis: "dashboard.nav.diagnosis",
    "AI KPIs": "dashboard.nav.aiKpis",
    ABHA: "dashboard.nav.abha",
    "PM-JAY": "dashboard.nav.pmjay",
    Support: "dashboard.nav.support",
    Campaigns: "dashboard.nav.campaigns",
    "Hospital QR": "dashboard.nav.hospitalQr",
    "My Subscription": "dashboard.nav.mySubscription",
    "My Profile": "dashboard.nav.myProfile",
  };
