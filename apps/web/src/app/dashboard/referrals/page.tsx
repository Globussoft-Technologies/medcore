        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40 p-4">
          ...
          */}
          ...
          >
            ...
            <div className="mb-4">
              <label htmlFor="referral-patient-search" className="mb-1 block text-sm font-medium">Patient</label>
            ...
            {!isDoctor && (
              <div className="mb-4">
                <label htmlFor="referral-from-doctor" className="mb-1 block text-sm font-medium">
                  Referring Doctor (From)
                </label>
                <select
                  id="referral-from-doctor"
            ...
            {mode === "internal" ? (
              <div className="mb-4">
                <label htmlFor="referral-to-doctor" className="mb-1 block text-sm font-medium">To Doctor</label>
                <select
                  id="referral-to-doctor"
              ...
              <div className="mb-4 grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                <div>
                  <label htmlFor="referral-ext-contact" className="mb-1 block text-sm font-medium">Contact</label>
                  <input
                    id="referral-ext-contact"
                    type="text"
            ...
            <div className="mb-4">
              <label htmlFor="referral-reason" className="mb-1 block text-sm font-medium">
            ...
            <div className="mb-4">
              <label htmlFor="referral-notes" className="mb-1 block text-sm font-medium">Notes</label>
              <textarea
                id="referral-notes"
                value={form.notes}
