      ...
      <header className="flex flex-col gap-3 sm:flex-row sm:items-start sm:justify-between">
            ...
            {tenant.config?.code && (
              <>
                <span
                  ...
                  className="rounded bg-slate-100 px-2 py-0.5 font-mono font-semibold text-slate-700"
                >
                  {tenant.config.code}
                </span>
                <span>•</span>
        ...
        <div className="flex flex-wrap items-center gap-2">
          <button
            ...
            onClick={() => void load()}
            disabled={loading}
            className="inline-flex h-11 items-center gap-1 rounded-md border border-gray-300 bg-white px-3 text-xs font-medium text-gray-700 hover:bg-gray-50"
          >
            <RefreshCw
              size={14}
          ...
          {tenant.active ? (
            <button
              ...
              className="inline-flex h-11 items-center gap-1 rounded-md border border-rose-300 bg-white px-3 text-xs font-medium text-rose-700 hover:bg-rose-50 disabled:cursor-not-allowed disabled:opacity-50"
              title={
            ...
            <>
              <button
                ...
                className="inline-flex h-11 items-center gap-1 rounded-md border border-emerald-300 bg-white px-3 text-xs font-medium text-emerald-700 hover:bg-emerald-50"
              >
            ...
            return (
              ...
              >
                <span className="flex items-center gap-2">
                  ...
                  <span
                    className={
                      completedAt ? "text-gray-900" : "text-gray-500"
                    }
                  >
                    {step.label}
                  </span>
...
function ArchiveLifecycleCard(props: {
    ...
    return (
      ...
      >
        <div className="mb-3 flex items-center gap-2">
          ...
          <span className="rounded-full bg-slate-300 px-2 py-0.5 text-[10px] font-semibold uppercase tracking-wide text-slate-800">
            Archived
          </span>
        </div>
        <dl className="grid grid-cols-1 gap-2 text-sm sm:grid-cols-2">
          <div>
            <dt className="text-xs text-gray-500">Archived at</dt>
          ...
          <div className="sm:col-span-2">
            <dt className="text-xs text-gray-500">S3 key</dt>
            <dd className="break-all font-mono text-xs">
              {tenant.archiveS3Key ?? "—"}
            </dd>
          </div>
          <div className="sm:col-span-2">
            <dt className="text-xs text-gray-500">SHA-256 checksum</dt>
  ...
  return (
    ...
    >
      <div className="mb-3 flex items-center gap-2">
        <Archive size={16} className="text-amber-700" aria-hidden="true" />
      ...
      <dl className="grid grid-cols-1 gap-2 text-sm sm:grid-cols-3">
        <div>
          <dt className="text-xs text-amber-800">Suspended on</dt>
          <dd className="font-medium text-gray-900">
            {formatDate(tenant.deactivatedAt)}
          </dd>
        </div>
        <div>
          <dt className="text-xs text-amber-800">Days since suspend</dt>
          <dd
        ...
        <div>
          <dt className="text-xs text-amber-800">Auto-archive in</dt>
          <dd
            className="font-medium text-gray-900"
      ...
      <div className="mt-3 flex flex-wrap items-center gap-2">
        ...
        {!eligible && (
          <button
            ...
            className="inline-flex h-10 items-center gap-1 rounded-md border border-rose-300 bg-white px-3 text-xs font-medium text-rose-700 hover:bg-rose-50"
      ...
      <dl className="space-y-1 text-xs">
        {props.rows.map(([k, v], i) => (
          <div key={i} className="flex gap-2">
            {k ? (
              <dt className="min-w-[5rem] font-medium text-gray-500">{k}</dt>
            ) : null}
