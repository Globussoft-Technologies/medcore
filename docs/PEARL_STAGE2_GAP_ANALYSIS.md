...
| Fraud detection (claims / billing anomaly) | 🟡 Productise | [`routes/ai-fraud.ts`](../apps/api/src/routes/ai-fraud.ts) + [`services/ai/fraud-detection.ts`](../apps/api/src/services/ai/fraud-detection.ts); [`/dashboard/ai-fraud/`](../apps/web/src/app/dashboard/ai-fraud/) | Flag: `aiFraud`. |
